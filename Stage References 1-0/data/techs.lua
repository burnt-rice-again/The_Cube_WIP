data.tech_categories = {
	...
	},
	{
		...
		is_shown = function(cat)
			local f = Game.GetLocalPlayerFaction()
			return f:IsUnlocked("x_elain_ending") or f:IsUnlocked("x_higgs_ending")
		end,
...
data.techs.t_human_faction_npc = {
	...
	unlocks = {
		...
		'transformer', 'smallreactor', 'crystal_powder',
		'x_tutorial', 'x_bugs',
		...
		'v_infected', 'v_broken', 'v_unpowered', 'v_emergency', 'v_powereddown', 'v_moving', 'v_pathblocked', 'v_idle', 'v_setnum', 'v_maxrange',
		...
		'f_human_vehiclefactory', 'f_human_tankframe', 'c_human_tank_turret', 'f_human_rover', 'f_heavy_bunker', 'f_human_commandcenter',
