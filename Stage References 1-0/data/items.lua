...
data.items.metalbar = {
	...
	production_recipe = CreateProductionRecipe({ metalore = 1 }, { c_fabricator = 20, c_reforming_pool = 40, c_human_refinery = 40 }),
}
...
data.items.metalplate = {
	...
	production_recipe = CreateProductionRecipe({ metalbar = 2 }, { c_fabricator = 30, c_reforming_pool = 60, c_human_refinery = 60 }),
}
...
data.items.anomaly_particle = {
	...
	desc = "A particle of pure anomaly data. Can be extracted from non magnified Blight Crystal with any anomaly container",
	slot_type = "anomaly",
	stack_size = 20,
...
data.items.power_petal = {
	...
	slot_type = "storage",
	stack_size = 10,
	production_recipe = CreateProductionRecipe({ obsidian_brick = 5, blight_extraction = 10 }, { c_advanced_refinery = 150, c_alien_droneport = 100 }), -- c_refinery
...
data.items.phase_leaf = {
	...
	slot_type = "storage",
	stack_size = 10,
	production_recipe = CreateProductionRecipe({ obsidian_brick = 5, blight_plasma = 5 }, { c_advanced_refinery = 200, c_alien_droneport = 100 }), -- c_refinery
