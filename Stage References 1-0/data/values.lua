...
data.values.v_is_foundation = { tag = 'entityfilter', index =  7, name = "Foundation",           desc = "Foundations without a building on top", texture = "Main/textures/icons/values/foundation.png" }
...
data.values.v_destroyed        = { name = "Destroyed Object", desc = "The target that was referenced here has been destroyed", texture = "Main/textures/icons/values/destroyed.png" }
