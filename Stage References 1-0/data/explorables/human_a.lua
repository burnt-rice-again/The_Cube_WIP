...
local f_human_explorer_broken = Frame:RegisterFrame("f_human_explorer_broken", {
	size = "Mission", race = "human", index = 3001, name = "Human Explorer (Broken)",
...
Frame:RegisterFrame("f_human_explorer", {
	size = "Mission", race = "human", index = 3002, name = "Human Explorer",
