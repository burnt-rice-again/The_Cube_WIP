...
Frame:RegisterFrame("f_explorable_spaceelevator", {
	size = "Mission", race = "human", index = 3999, name = "Space Elevator",
	visibility_range = 25,
...
local f_human_explorer_upgraded = Frame:RegisterFrame("f_human_explorer_upgraded", {
	size = "Mission", race = "human", index = 3003, name = "AI Explorer",
...
function MapMsg.OnSolvedExplorable(faction, solved_explorable_visual_id)
	if solved_explorable_visual_id == "v_explorable_building_4" then
		FactionCount("m_human_b", 3, faction, 'set_if_one_less')
	elseif solved_explorable_visual_id == "v_explorable_building_2" then
		FactionCount("m_human_b", 4, faction, 'set_if_one_less')
	elseif solved_explorable_visual_id == "v_explorable_building_6" then
		FactionCount("m_human_b", 5, faction, 'set_if_one_less')
	elseif solved_explorable_visual_id == "v_human_explorable_5x5_a" then
