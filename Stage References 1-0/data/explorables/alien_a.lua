...
function MapMsg.OnSolvedExplorable(faction, solved_explorable_visual_id)
	if solved_explorable_visual_id ~= "v_explorable_blightanomaly_02" then return end
...
<img image="Main/textures/codex/missions/alien_a/08_alien_a_08.png"/>]],
			},
			{
				...
				snd = "fx_420_elain",
				txt = [[
If you decide to follow through with this Commander, then <hl>build a Console</> as HIGGS suggests, but work to <hl>stabilize</> your world, not destroy it.]],
