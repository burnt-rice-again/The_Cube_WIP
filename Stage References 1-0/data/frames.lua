...
data.frames.sampleframe = {
	...
	start_blight_shield = true, -- entity starts out with  the blight_shield flag set
...
local FrameCarapace = setmetatable({ shield_type = 'carapace', start_blight_shield = true }, { __index = Frame })  -- FramePhysical
local FrameObsidian = setmetatable({ shield_type = 'obsidian', start_blight_shield = true }, { __index = Frame })   -- FramePlasma
...
Frame:RegisterFrame("f_beacon", {
	...
	desc = "A position marker in the world with item transfer ability",
	health_points = 1,
	minimap_color = { 0.5, 0.3, 1 },
	visibility_range = 3,
	slots = { storage = 1 },
	texture = "Main/textures/icons/frame/deployment_beacon.png",
	construction_recipe = CreateConstructionRecipe({ beacon_frame = 1 }, 5),
	trigger_channels = "building",
	visual = "v_beacon",
	power = -1,
	no_foundations = true,
...
Frame:RegisterFrame("f_building1x1g", {
	...
	slots = { storage = 16 },
	health_points = 100, --150
	construction_recipe = CreateConstructionRecipe({ reinforced_plate = 5, circuit_board = 1 }, 75),
...
Frame:RegisterFrame("f_building2x1a", {
	size = "Medium", race = "robot", index = 1013, name = "Building 1x2 (2M)",
	minimap_color = { 0.8, 0.8, 0.8 },
	visibility_range = 15,
	slots = { storage = 4 },
...
Frame:RegisterFrame("f_building2x1e", {
	size = "Medium", race = "robot", index = 1015, name = "Building 1x2 (2S1M)",
	minimap_color = { 0.8, 0.8, 0.8 },
	visibility_range = 15,
...
Frame:RegisterFrame("f_building2x1f", {
	size = "Medium", race = "robot", index = 1012, name = "Building 1x2 (1M1S)",
	minimap_color = { 0.8, 0.8, 0.8 },
	visibility_range = 15,
	slots = { storage = 4 },
...
Frame:RegisterFrame("f_building2x1g", {
	size = "Medium", race = "robot", index = 1011, name = "Building 1x2 (1M)",
	minimap_color = { 0.8, 0.8, 0.8 },
	visibility_range = 15,
	slots = { storage = 4 },
...
Frame:RegisterFrame("f_bot_1s_a", {
	...
	start_disconnected = true,
	power = -2,
	health_points = 150, -- 50
	components = { { "c_integrated_capacitor", "hidden" } },
	flags = "AnimateRoot",
	trigger_channels = "bot",
	production_recipe = CreateProductionRecipe({ circuit_board = 1, metalbar = 5 }, { c_assembler = 35, c_robotics_factory = 20, c_carrier_factory = 35 }),
	visual = "v_bot_1s_a",
})

Frame:RegisterFrame("f_bot_1s_b", {
	...
	start_disconnected = true,
	power = -3,
	health_points = 200, -- 100
	components = { { "c_integrated_capacitor", "hidden" } },
	flags = "AnimateRoot",
	trigger_channels = "bot",
	production_recipe = CreateProductionRecipe({ energized_plate = 1, circuit_board = 5 }, { c_robotics_factory = 30 }),
	visual = "v_bot_1s_b",
})

Frame:RegisterFrame("f_bot_2s", {
...
f_alien_explorable:RegisterFrame("f_explorable_simulator", {
	size = "Mission", race = "alien", index = 5999, name = "The Simulator",
...
Frame:RegisterFrame("f_resourcenode_metal",         CreateResourceDef(1, "Metal Ore Deposit",            'metalore',       { 0.4, 0.6, 0.6 }, "Main/textures/icons/frame/resource_metalore.png"))
...
function f_bug_hive:on_destroy(entity, damager)
	...
	local damager_location = damager.location -- is nil if damager were destroyed
	Map.Defer(function()
...
Frame:RegisterFrame("f_building1x1e", {
	...
	slots = { storage = 24 },
	health_points = 400, -- 200,
	construction_recipe = CreateConstructionRecipe({ hdframe = 5, icchip = 1 }, 80),
...
Frame:RegisterFrame("f_building2x1b", {
	size = "Large", race = "robot", index = 2, name = "Building 1x2 (1M1L)",
	minimap_color = { 0.8, 0.8, 0.8 },
	visibility_range = 15,
...
Frame:RegisterFrame("f_building2x1c", {
	size = "Medium", race = "robot", index = 1014, name = "Building 1x2 (2M)",
	minimap_color = { 0.8, 0.8, 0.8 },
	visibility_range = 15,
...
Frame:RegisterFrame("f_building2x1d", {
	size = "Medium", race = "robot", index = 1016, name = "Building 1x2 (1M)",
	minimap_color = { 0.8, 0.8, 0.8 },
	visibility_range = 15,
	health_points = 250, -- 150
	slots = { storage = 24 },
...
Frame:RegisterFrame("f_building3x2b", {
	size = "Medium", race = "robot", index = 1031, name = "Building 2x3 (2M2S)",
	minimap_color = { 0.8, 0.8, 0.8 },
	visibility_range = 35,
...
FrameObsidian:RegisterFrame("f_hybrid_worker", {
	...
	visibility_range = 8,
	slots = { storage = 3, anomaly = 1},
	production_recipe = CreateProductionRecipe({ shaped_obsidian = 10, reinforced_plate = 5, anomaly_heart = 1 }, { c_alien_factory_robots = 160 }),
	health_points = 350,
	power = -2,
	movement_speed = 5,
	trigger_channels = "bot",
