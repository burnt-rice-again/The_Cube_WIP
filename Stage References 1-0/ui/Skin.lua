...
data.brushes = {
	...
	editor_pan_bg           = { "Main/skin/Assets/Editor Pan BG.png", slice = 0.2 },
...
data.categories = {
	...
	{ name = "Filter Value",         tab = 'value', defs = data.values,     filter_field = 'tag',             filter_val = 'entityfilter'      },
	{ name = "Label Value",          tab = 'value', defs = data.values,     filter_field = 'tag',             filter_val = 'value'             },
	...
	{ name = "Mission",              tab = 'frame', defs = data.frames,     filter_field = 'size',            filter_val = "Mission"           },
	...
	{ name = "Foundation",           tab = 'frame', defs = data.frames,     filter_field = 'size',            filter_val = "Foundation"        },
	{ name = "Wall",                 tab = 'frame', defs = data.frames,     filter_field = 'size',            filter_val = "Wall"              },
	{ name = "Other Construction",   tab = 'frame', defs = data.frames,     filter_field = 'size',            filter_val = "Other"             },
	{ name = "Resource Node",        tab = 'frame', defs = data.frames,     filter_field = 'type',            filter_val = "Resource"          },
