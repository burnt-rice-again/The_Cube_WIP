...
-- Cai Added
    -- adjust the amount of trees, 0=tons, >1 = none
...
local desert_level = -0.5 --above this line cactus will appear
local grass_level = -0.15 --above this line trees will appear
...
local metal_coverage = 0.4 -- Variation coverage
local metal_dropped_coverage = 0.1
local metal_patch_size = 0.5 -- richness width from edge -1 -> 1
local metal_patch_falloff = 0.25 -- richness falloff
local metal_dropped_falloff = 0.35
local metal_dist_falloff = 0.5 -- distance
local metal_edge = 1
...
local blight_crystal_patch_falloff = 0
...
local obsidian_dist_falloff = 0 -- distance
...
local resources = {
	...
	-- rich metal
	{
		...
		nodes = {
			{
				visuals = { "v_simulator_ruined", "v_2x2_a_ruined","v_crashedship_2x2_moss","v_crashedship_2x2_desert","v_explorable_building_4","v_explorable_building_6","v_explorable_building_3" },
				resource = { metalore = resource_inf and {REG_INFINITE ,REG_INFINITE } or { metal_richness_min*45*4, metal_richness_max*55*4 } },
			},
		}
	},
	-- normal metal
	{
		...
		functions = {
			{ func = "Threshold", param = "Blightness", range = { -1, blight_threshold } },
			{ func = "Threshold", param = "Elevation", range = { desert_level, grass_level }, falloff = 5},
		...
		nodes = {
			{
				visuals = { "v_battery_01_l_ruined", "v_missile_launcher_m_ruined","v_transporter_01_m_ruined","v_crashedship_2x1_moss","v_crashedship_2x1_desert","v_explorable_glitchbuilding","v_explorable_brokenship_1",}, -- "v_metalmedium1b", "v_metalmedium1c", "v_metalmedium1a", },
				resource = { metalore = { metal_richness_min*6, metal_richness_max*10 } },
				functions = {
...
local foliage = {
	...
	-- many succulents groups
	{
		...
		nodes = {
			{
				visuals = { "v_succulent_01", "v_succulent_02", "v_succulent_03", "v_succulent_05_A", "v_succulent_05_B", "v_succulent_05_C" },
				functions = {
